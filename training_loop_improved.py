...
from oadino.models import ConvVAE64, OADinoModel, OADinoPreProcessor
...
clevrtex = Path("/ssd2/mldata/CLEVRTexV2/clevrtexv2_full/")
...
trainer.train("/ssd2/mldata/oadino", 15)
